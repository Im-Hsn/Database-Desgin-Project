...
CREATE TABLE `storagelocation` (
  ...
  CONSTRAINT `storagelocation_ibfk_1` FOREIGN KEY (`Plant_ID`) REFERENCES `plant` (`Plant_ID`)
...
INSERT INTO `storagelocation` VALUES (1,2,'Cell'),(2,6,'Tablets'),(3,8,'KIT_MAT'),(4,10,'PADS'),(5,4,'TOYS');
